import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-8bbb72b2.js";const t={},i=e(`<h2 id="实验10-8-设计函数-void-delcharfun-char-str-char-ch" tabindex="-1"><a class="header-anchor" href="#实验10-8-设计函数-void-delcharfun-char-str-char-ch" aria-hidden="true">#</a> 实验10_8_设计函数 void delcharfun(char *str,char ch)</h2><p>设计函数 void delcharfun(char *str,char ch)实现从字符串str中删除指定的字符ch。同一字母的大、小写按不同字符处理。</p><h3 id="函数接口定义" tabindex="-1"><a class="header-anchor" href="#函数接口定义" aria-hidden="true">#</a> 函数接口定义：</h3><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>void delcharfun(char *str,char ch);
