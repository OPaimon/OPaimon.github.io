...
export default hopeTheme({
  hostname: "https://opaimon.github.io",

  author: {
    name: "观赏用派蒙",
    url: "opaimon.github.io",
    email: "paimoe@bupt.edu.cn"
  },
...
//  logo: "/logo.svg",
  ...
  repo: "opaimon/opaimon.github.io",
  ...
  blog: {
    name: "观赏用派蒙",
    avatar: "/avatar_opaimon.png",
    roundAvatar: true,
    description: "一个混吃等死的大学生，现在在 巴普特大学(划掉 摆烂",
    intro: "/intro.html",
    medias: {
      BiliBili: "https://space.bilibili.com/14393410",
      GitHub: "https://github.com/OPaimon",
      QQ: "https://qm.qq.com/cgi-bin/qm/qr?k=fDoQ5dmNi0PYBQsqGdsdBNcB-TPSwusQ",
    },
  },
  ...
  plugins: {
    ...
    comment: {
      ...
      provider: "Waline",
      serverURL: "https://opaimon-github-io-comment-r6qvcouch-opaimon.vercel.app/",
    },
